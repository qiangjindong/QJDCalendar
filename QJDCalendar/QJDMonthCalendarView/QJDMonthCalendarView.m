...
- (void)setupSubViews {
    ...
    [previousBtn setImage:[UIImage imageNamed:@"QJDBundle.bundle/icon_prev.png"] forState:UIControlStateNormal];
    ...
    [nextBtn setImage:[UIImage imageNamed:@"QJDBundle.bundle/icon_next"] forState:UIControlStateNormal];
